...
function exportdata(){
    ...
    window.open("../api/getHashtagNetwork?researches=" + reserchesstring );

}


function getRelations(clearGraph){
    $.getJSON("../api/getHashtagNetwork", { "researches" : reserchesstring , "limit" : 20 })
    .done(function(data){
        ...
        for(var i = 0; i<data.nodes.length; i++){
            var u = {
                "id" : data.nodes[i].label,
                "nick" : data.nodes[i].label,
                "pu" : data.nodes[i].c
            };
